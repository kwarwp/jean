...
Traceback (most recent call last):
  ...
  module <module> line 2
    from _spy.vitollino.main import Mapa, Sala, STYLE, Codigo as Code, INVENTARIO, Elemento, NS,Texto
'''},
{'date': 'Tue Aug 28 2018 15:57:30.148 GMt-0300 (-03) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
Traceback (most recent call last):
  ...
  module <module> line 2
    from _spy.vitollino.main import Mapa, Sala, STYLE, Codigo as Code, INVENTARIO, Elemento, NS,Texto
'''},
{'date': 'Tue Aug 28 2018 16:04:40.118 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
'''},
{'date': 'Tue Aug 28 2018 16:09:55.678 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module <module> line 90
    Labirinto.m  (sala_0, sala_1, sala_2, sala_3, sala_4, sala_5, sala_6, sala_7, sala_8, sala_9, sala_A, sala_B, sala_C, sala_D, Sala_E)
NameError: name 'Sala_E' is not defined
'''},
{'date': 'Tue Aug 28 2018 16:10:22.170 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module <module> line 94
    Museu()
  module <module> line 90
    Labirinto.m  (sala_0, sala_1, sala_2, sala_3, sala_4, sala_5, sala_6, sala_7, sala_8, sala_9, sala_A, sala_B, sala_C, sala_D)
TypeError: m() takes 1 positional argument but more were given
'''},