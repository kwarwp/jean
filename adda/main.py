...
C2_NORTE = "https://i.imgur.com/FlwvTzi.jpg" #acho que poderia tirar da parede dentro do ambiente e nao antes da porta
...
class Museu:
    ...
    def __init__(self):  
        ...
        sala_1 = Sala(C1_NORTE, C1_LESTE, C1_SUL, C1_OESTE)
