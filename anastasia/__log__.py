...
SyntaxError: invalid syntax
'''},
{'date': 'Wed Aug 15 2018 06:11:26.468 GMt-0300 (-03) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
AttributeError: 'Codigo' object has no attribute 'elf'
'''},
{'date': 'Wed Aug 15 2018 06:11:49.11 GMt-0300 (-03) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
SyntaxError: invalid syntax
'''},
{'date': 'Wed Aug 15 2018 07:45:05.983 GMt-0300 (-03) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module <module> line 247
    STYLE = dict(width=400,heigth="250px",left=200,top=500, bottom=100, position = absolute)
