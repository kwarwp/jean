...
from _spy.vitollino.main import Sala, STYLE, Codigo, Elemento
    ...
    def __init__(self):        
       ...
       # cod =Codigo(cena=sala_1.sul, topo = "como vai?",codigo = "if True:print('ooi')",style = dict(width=400,heigth="250px",left=500,top=100))
        ...
        MENSAGENS=[
                  ...
                  [sala_7.oeste ,"Para inserir um elemento à Cena é necessário escolher uma imagem para ser adicionada e, em seguida, nomeá-la e colocar seu link entre aspas, assim como foi feito com as imagens destinadas a formar as cenas",  "Feito isso, é preciso importar o Elemento do Vitollino usando o código:from _spy.vitollino.main import Elemento",  "Definimos um nome e igualamos ao Elemento, seguido de um parenteses contendo o nome da imagem que vai representá-lo, seguido das suas dimensões",  "Para ajustar tamanho e posicionamento do Elemento definimos os valores das dimensões da seguinte maneira:",
